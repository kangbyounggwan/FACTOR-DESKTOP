                  ...
                  <div className="flex items-start gap-3">
                    <div className="flex-1 min-w-0 space-y-2">
                      <div className="flex items-center gap-2 min-w-0">
                        <h4 className="ui-fs-xs font-medium tracking-tight text-foreground truncate">
                          {eq.name}
                        </h4>
                      ...
                      <div className="flex items-center gap-3 ui-fs-xs">
...
function LineChip({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "h-7 px-2.5 rounded ui-fs-xs font-medium tracking-tight whitespace-nowrap transition-colors",
        active
