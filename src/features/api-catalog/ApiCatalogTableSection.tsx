    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-1 p-1 rounded-md bg-foreground/[0.03] border border-border/40 overflow-x-auto max-w-[55%]">
          ...
          {domains.length > 6 && (
            <span className="text-xs text-foreground/40 px-1.5">
              +{domains.length - 6}
            </span>
          )}
        </div>
        ...
        <div className="ml-auto text-xs text-foreground/45 font-mono tabular-nums whitespace-nowrap">
          {items.length}
  ...
  return (
    <div className="bg-foreground/[0.025] px-4 py-3">
      ...
      <div className="mt-1.5 flex items-baseline gap-2">
        ...
        {hint && (
          <span className="ui-fs-xs text-foreground/40 font-mono tabular-nums">
            {hint}
          </span>
        )}
      </div>
    ...
    <>
      ...
      >
        ...
        <td className="px-3 py-3 align-top">
          ...
          {entry.path_template ? (
            <div
              className="text-xs font-mono text-emerald-400/85 mt-1 truncate leading-tight"
            ...
            <div className="text-xs text-foreground/35 mt-1 leading-tight">
              <span className="inline-block h-1 w-1 rounded-full bg-foreground/25 mr-1.5 align-middle" />
              path 미시드 · 코드 fallback
            </div>
          )}
          <div className="ui-fs-xs text-foreground/45 mt-1.5 font-mono tabular-nums truncate">
        ...
        {/* 설명 — korean_label 만 */}
        <td className="px-3 py-3 align-top">
          <div className="ui-fs-xs font-medium text-foreground leading-snug">
            {entry.korean_label || (
        ...
        {/* 도메인 — flat chip */}
        <td className="px-3 py-3 align-top">
          <span className="inline-flex items-center ui-fs-xs font-medium tracking-tight text-foreground/75 bg-foreground/[0.05] px-2 py-0.5 rounded">
            {entry.domain}
          </span>
        </td>
        ...
        <td className="px-3 py-3 align-top">
          <span className="inline-flex items-center gap-1.5">
            ...
            <span className={cn("text-xs font-mono", tier.text)}>
              {entry.cost_tier}
            </span>
          </span>
        </td>
